...
public:
	static std::pair <std::string, std::shared_ptr<ParameterBase> >
		Float(const std::string& name, Ceres::FilterType type, float& value, float min, float max, const std::string& desc = "", 
	...
	static std::pair <std::string, std::shared_ptr<ParameterBase> >
		Int(const std::string& name, Ceres::FilterType type, int& value, int min, int max, const std::string& desc = "", 
			Ceres::ObserverFlag flag = Ceres::ObserverFlag::MESH)
	{
	...
	static std::pair <std::string, std::shared_ptr<ParameterBase> >
		Boolean(const std::string& name, Ceres::FilterType type, bool& value, const std::string& desc = "", 
			Ceres::ObserverFlag flag = Ceres::ObserverFlag::MESH)
	{
	...
	static std::pair <std::string, std::shared_ptr<ParameterBase> >
		Vec3(const std::string& name, Ceres::FilterType type, glm::vec3& value, float min, float max, const std::string& desc = "", 
			Ceres::ObserverFlag flag = Ceres::ObserverFlag::MESH)
	{
