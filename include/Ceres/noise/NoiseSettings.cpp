...
NoiseSettings::NoiseSettings()
	: _parameters {
		{ PlanetLab::ParameterFactory::Float("Strength", FilterType::Simple, ObserverFlag::MESH, _strength, 0.0f, 10.0f) },
		{ PlanetLab::ParameterFactory::Float("Base Roughness", FilterType::Simple, ObserverFlag::MESH, _baseRoughness, 0.0f, 10.0f) },
		{ PlanetLab::ParameterFactory::Float("Roughness", FilterType::Simple, ObserverFlag::MESH, _roughness, 0.0f, 10.0f) },
		{ PlanetLab::ParameterFactory::Vec3("Center", FilterType::Simple, ObserverFlag::MESH, _center, 0.0f, 10.0f) },
		{ PlanetLab::ParameterFactory::Int("Layers Count", FilterType::Simple, ObserverFlag::MESH, _layersCount, 0, 10) },
		{ PlanetLab::ParameterFactory::Float("Persistence", FilterType::Simple, ObserverFlag::MESH, _persistence, 0.0f, 10.0f) },
		{ PlanetLab::ParameterFactory::Float("Min Value", FilterType::Simple, ObserverFlag::MESH, _minValue, 0.0f, 10.0f) },
		{ PlanetLab::ParameterFactory::Float("Weight Multiplier", FilterType::Rigid, ObserverFlag::MESH, _weightMultiplier, 0.0f, 10.0f) },
	},
	_parametersNames{
		"Strength",
		"Base Roughness",
